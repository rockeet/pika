...
# etcd-cpp-api contains libprotobuf, dcompact_etcd had required
# libetcd-cpp-api
#export PROTO_BUF_LDFLAGS="-L/node-shared/lib -letcd-cpp-api"
export PROTO_BUF_LDFLAGS="-L/node-shared/vcpkg/installed/x64-linux/lib -lprotobuf"
